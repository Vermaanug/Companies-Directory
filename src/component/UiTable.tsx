...
function UiTable({ tableData, columnsSchema }: UiTableProps) {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 w-1/2">
        <div className="relative w-full sm:w-1/2">
          <input
            ...
            className="px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-transparent outline-none w-full"
          />
          {globalFilter && (
            <button
